...
def create_fallback_recommendations():
    ...
    try:
        ...
        pd.DataFrame(recommendations_list).to_csv(os.path.join(DATA_DIR, 'processed', 'client_recommendations.csv'), index=False)
...
def main():
    ...
    try:
        ...
        try:
            ...
            shap_df = pd.read_csv(os.path.join(DATA_DIR, 'processed', 'shap_values_sample.csv'))
    ...
    recommendations_df.to_csv(os.path.join(DATA_DIR, 'processed', 'client_recommendations.csv'), index=False)
